        ...
        <section className="relative flex items-center justify-center p-5 sm:p-6 lg:p-8">
          ...
          <div className="relative z-10 w-full max-w-[380px]">
              ...
              <div>
                ...
                <div className="mt-2 flex items-center gap-3 rounded-2xl bg-[#F4E7C5]/75 dark:bg-[#F4E7C5]/10 border border-[#D6B56D]/40 dark:border-[#F4E7C5]/10 px-4 py-3 focus-within:ring-2 focus-within:ring-[#C86B3C]/25 transition-all">
                  ...
                  <button
                    ...
                    className="shrink-0 text-[#7A6F45] hover:text-[#C86B3C] dark:text-[#F4E7C5]/60 dark:hover:text-[#D6B56D] transition-colors"
                  >
            ...
            <div className="mt-4 flex items-center justify-between gap-3">
              <label className="flex items-center gap-2 text-xs font-bold text-[#7A6F45] dark:text-[#F4E7C5]/60">
                <input
                  type="checkbox"
                  className="h-4 w-4 rounded border-[#D6B56D] accent-[#C86B3C]"
                />
                Remember me
              </label>
              ...
              <button
                type="button"
                className="text-xs font-black text-[#C86B3C] hover:text-[#9F4D2E] hover:underline"
              >
                Forgot?
              </button>
            </div>
