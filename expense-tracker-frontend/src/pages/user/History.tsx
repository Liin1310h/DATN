...
import { Edit2, ListFilter, Loader2, Search, Trash2, X } from "lucide-react";
...
export default function History() {
  ...
  return (
    <Layout>
      <div className="flex flex-col max-w-8xl mx-auto px-4 pb-4 h-full overflow-x-hidden">
        ...
        <div className="flex justify-between mb-2">
          <div className="flex  items-center gap-3 px-4 py-2 rounded-2xl bg-gray-100 dark:bg-gray-800/40  border-transparent focus-within:border-indigo-500/50 focus-within:bg-white dark:focus-within:bg-gray-800 transition-all duration-300">
            ...
            <input
              ...
              className="bg-transparent outline-none text-sm w-[50%] min-w-8 border-none font-medium text-gray-700 dark:text-white placeholder:text-gray-200 dark:placeholder:text-gray-500"
            />
            {searchTerm && (
              <button
